...
function M.textMetrics(fontString, constrainedWidth)
    ...
    local isLilita = path:find("LilitaOne-Regular", 1, true) ~= nil
    local charWidth, lineHeight = size * (isVTC and .40 or (isKalam and .47 or (isLilita and .52 or .55))), math.ceil(size * 1.2)
...
function M.writeSVG(root, path)
    ...
    local lines = {
        ...
        '<style>@font-face{font-family:Bangers;src:url("Fonts/Comic/Bangers-Regular.ttf")}@font-face{font-family:VTC;src:url("Fonts/Comic/VTC-Letterer-Pro.ttf")}@font-face{font-family:Kalam;src:url("Fonts/Comic/Kalam-Bold.ttf")}@font-face{font-family:Lilita;src:url("Fonts/Comic/LilitaOne-Regular.ttf")}</style>',
        ...
        elseif kind == "FontString" then
            ...
            if text and text ~= "" then
                ...
                local family = fontPath:find("Bangers",1,true) and "Bangers"
                    ...
                    or (fontPath:find("Kalam-Bold",1,true) and "Kalam"
                    or (fontPath:find("LilitaOne-Regular",1,true) and "Lilita" or "Arial, sans-serif")))
